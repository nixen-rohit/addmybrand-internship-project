...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <RiCloseLine size={25} className="text-white" onClick={onClick} />
  ) : (
    <RiMenu4Fill size={25} className="text-white" onClick={onClick} />
  );
};
...
export const NavbarLogo = () => {
  return (
    <Link
      href="/#home"
      className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 scroll-behavior
    ...
    >
      ...
      />
      <span className="font-medium text-white ">ADmyBRAND</span>
    </Link>
  );
};
